...
import shimanoStellaSw from "@/assets/shimano-stella-sw.jpg";
import shimanoStella18000 from "@/assets/shimano-stella-18000.jpg";
import shimanoForcemaster from "@/assets/shimano-forcemaster.jpg";
import electraMateTr from "@/assets/electra-mate-tr.jpg";
import electraMateBrute from "@/assets/electra-mate-brute.jpg";
import kristalXf655 from "@/assets/kristal-xf655.jpg";
import daiwaMarinePower from "@/assets/daiwa-marine-power.jpg";
import hookerTiagra from "@/assets/hooker-tiagra.jpg";
import pennInternational from "@/assets/penn-international.jpg";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product, index) => (
            <motion.div
              ...
              className="bg-card rounded-3xl p-4 border border-border shadow-sm hover:shadow-xl transition-all duration-300"
            >
              <span className="text-xs font-semibold bg-muted rounded-full px-3 py-1 text-muted-foreground">
                {product.category}
              </span>
              <div className="h-48 rounded-2xl my-4 overflow-hidden bg-white flex items-center justify-center">
                <img 
                  src={product.image} 
                  alt={product.name}
